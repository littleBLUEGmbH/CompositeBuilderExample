...
/**
  ******************************************************************************
  * @file           : usbd_custom_hid_if_1.h
  * @version        : v1.0_Cube
  * @brief          : Header for usbd_custom_hid_if_1.c file.
  ******************************************************************************
  * @attention
  *
...
#ifndef __USBD_CUSTOM_HID_IF_1_H__
#define __USBD_CUSTOM_HID_IF_1_H__
...
extern USBD_CUSTOM_HID_ItfTypeDef USBD_CustomHID_fops_FS_1;
...
#endif /* __USBD_CUSTOM_HID_IF_1_H__ */
